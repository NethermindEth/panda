	...
	return map[string]types.ModuleDoc{
		"prometheus": {
			...
			Functions: map[string]types.FunctionDoc{
				...
				"query_range": {
					Signature:   "prometheus.query_range(instance_name: str, promql: str, start: str, end: str, step: str) -> dict",
				...
				"get_labels": {
					Signature:   "prometheus.get_labels(instance_name: str) -> list[str]",
				...
				"get_label_values": {
					Signature:   "prometheus.get_label_values(instance_name: str, label: str) -> list[str]",
